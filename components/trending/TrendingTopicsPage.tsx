                ...
                {isLoading ? (
                  ...
                  suggestedTopics.map((topic: any, index: number) => (
                    <button
                      ...
                      className={`w-full rounded-xl px-[24px] py-[10px] text-left transition-colors duration-150 border border-gray-300 bg-white hover:border-blue-400 hover:bg-blue-100 `}
                    >
                      <div className="">
